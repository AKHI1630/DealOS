...
import { Search, Filter, MoreHorizontal, Mail, Building2 } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold tracking-tight mb-1">All Leads</h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-sm">View and manage all your prospected leads.</p>
        </div>
